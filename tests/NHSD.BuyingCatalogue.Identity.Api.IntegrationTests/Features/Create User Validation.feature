...
@3538
Scenario: One hundred and one character first name yields a first name is too long error
    When a POST request is made to create a user for organisation Organisation 2
        | FirstName                | LastName   | PhoneNumber | EmailAddress             |
...
@3538
Scenario: One hundred and one character last name yields a last name is too long error
    When a POST request is made to create a user for organisation Organisation 2
        | FirstName | LastName                 | PhoneNumber | EmailAddress             |
...
@3538
Scenario: A thirty six character phone number yields a phone number is too long error
    When a POST request is made to create a user for organisation Organisation 2
        | FirstName | LastName   | PhoneNumber             | EmailAddress             |
