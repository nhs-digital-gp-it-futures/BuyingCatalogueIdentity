...
@3568
Scenario: User logs out and is unable to access protected resources without logging in first
...
Scenario: Navigating directly to the logout page, should redirect the user to the public browse homepage
    Given a user has successfully logged in with email address a@b.com and password yolo
