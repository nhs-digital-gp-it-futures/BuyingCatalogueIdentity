...
@3924
Scenario: The back to home page element links to the public browse homepage
    Then the go back element should link to the public browse homepage

@3924
Scenario: The back to log in link shows the correct text
    Then the page contains element with Data ID go-back-link
    And element with Data ID go-back-link has text Back to homepage

@3924
Scenario: The Accept Agreement page title is displayed correctly
...
@3924
Scenario: The Checkbox element is displayed correctly
...
@3924
Scenario: The Submit button is displayed correctly
