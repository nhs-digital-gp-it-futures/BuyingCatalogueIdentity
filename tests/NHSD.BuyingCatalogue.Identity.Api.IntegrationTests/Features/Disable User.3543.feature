...
@3543
Scenario: 1. An authority user can disable a users account
	Given a user is logged in
		| Username          | Password | Scope        |
		| authority@doe.com | yolo     | Organisation |
	When a POST request is made to disable user 234
...
Scenario: 2. User is not found
	Given a user is logged in
		| Username          | Password | Scope        |
		| authority@doe.com | yolo     | Organisation |
	When a POST request is made to disable user unknown
