...
Scenario: 2. The back to log in link is displayed correctly
    ...
    And element with Data ID go-back-section contains a link to / with text Back to Public Browse
...
@3924
Scenario: 4. The Accept Agreement page description is displayed correctly
...
@3924
Scenario: 5. The Checkbox element is displayed correctly
