...
@5447
Scenario: Null scope yields the expected claims
...
@5447
Scenario: Unknown scope yields no access token
    Given a user is logged in
        | Username            | Password     | Scope   |
...
@5447
Scenario: Get the claims of a buyer user with invalid primary organisation id
    Given a user is logged in
        | Username            | Password     | Scope   |
...
@5447
Scenario: Get the claims of an authority user with valid primary organisation id
    Given a user is logged in
        | Username             | Password        | Scope        |
...
@5447
Scenario: Get the claims of an authority user with invalid primary organisation id
    Given a user is logged in
        | Username             | Password        | Scope        |
