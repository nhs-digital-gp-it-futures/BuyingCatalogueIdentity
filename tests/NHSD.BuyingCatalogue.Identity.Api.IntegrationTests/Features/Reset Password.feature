...
@3926
Scenario: Entering a valid password, allows the user to proceed
...
@3926
Scenario: User cannot use the same link to set their password twice
    When The email link is clicked
    Then the user is redirected to page identity/account/resetpassword
    When element with Data ID input-reset-password is populated with Password123!
    And element with Data ID input-confirm-reset-password is populated with Password123!
...
@3926
Scenario: User cannot modify the link to set someone elses password
    When The email link is modified to use email address other@user.com
    When The email link is clicked
    Then the user is redirected to page account/resetpasswordexpired

@3926
Scenario: Not adhering to the password policy but entering matching passwords, but gives the user a relevant error message
    When The email link is clicked
    Then the user is redirected to page identity/account/resetpassword
...
@3926
Scenario: Adhering to the password policy but entering mismatched passwords gives the user a relevant error message
    When The email link is clicked
    Then the user is redirected to page identity/account/resetpassword
    When element with Data ID input-reset-password is populated with Password123!
...
@3926
Scenario: Not adhering to the password policy & entering mismatched passwords gives the user a relevant error message
    When The email link is clicked
    Then the user is redirected to page identity/account/resetpassword
    When element with Data ID input-reset-password is populated with Pass1
...
@3926
Scenario: Pressing submit without entering a password gives the user a relevant error message
    When The email link is clicked
    Then the user is redirected to page identity/account/resetpassword
