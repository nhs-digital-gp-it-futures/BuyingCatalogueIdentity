...
Scenario: Organisation is not found
    Given a user is logged in
         | Username            | Password     | Scope        |
         | PennyLane@email.com | S0mePa$$w0rd | Organisation |
    And an Organisation with name Organisation1 does not exist
    When a GET request for RelatedOrganisations is made for an Organisation with name Organisation1
